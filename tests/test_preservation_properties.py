        ...
        "boundedContexts": [
            {
                "name": name,
                "type": draw(
                    st.sampled_from(["FEATURE", "APPLICATION", "SYSTEM", "TEAM"])
                ),
            }
...
class TestPreservationProperties:
    ...
    def test_simple_context_map_conversion_preserved(self, simple_context_map):
        ...
        assert (
            "ContextMap" in result or "BoundedContext" in result
        ), "Should contain CML keywords"
    ...
    def test_round_trip_validator_creation_preserved(self):
        ...
        ), "Should have validate_round_trip method"
    ...
    def test_context_map_with_relationships_conversion_preserved(
        self, complex_context_map
    ):
        """
        ...
        if relationships:
            ...
            assert any(
                rel["type"] in result for rel in relationships
    ...
    def test_validation_error_structure_preserved(self):
        ...
        error = ValidationError(
            message="Test error", property_path="test.path", error_type="TEST_ERROR"
        )
    ...
    def test_validation_result_structure_preserved(self):
        ...
        error = ValidationError(message="Test", property_path="", error_type="TEST")
    ...
    def test_converter_template_system_preserved(self):
        ...
        assert hasattr(
            converter, "context_map_template"
        ), "Should have context_map_template"
        assert hasattr(
            converter, "bounded_context_template"
        ), "Should have bounded_context_template"
        assert hasattr(
            converter, "aggregate_template"
        ), "Should have aggregate_template"
    ...
    def test_tactical_patterns_conversion_preserved(self, tactical_patterns_example):
        ...
        assert (
            "Aggregate" in result or "Entity" in result
    ...
    def test_context_map_types_handled_consistently(self, context_map_type):
        ...
        """
        json_data = {
            "contextMap": {"type": context_map_type, "contains": ["TestContext"]},
            "boundedContexts": [{"name": "TestContext", "type": "FEATURE"}],
        }
